...
public class ImageUtils {
    ...
    public static void loadImageCrop(Context mContext, String path, ImageView mImageView) {
        ...
        GlideApp.with(mContext).load(path).centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL).into(mImageView);
    }
    ...
    public static void loadImageViewAnim(Context mContext, String path, int anim, ImageView mImageView) {
        GlideApp.with(mContext).load(path).transition(GenericTransitionOptions.<Drawable>with(anim)).into(mImageView);
    }
